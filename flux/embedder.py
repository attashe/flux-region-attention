...
def load_t5(model_path: str, device: Union[str, torch.device] = "cuda", max_length: int = 512) -> HFEmbedder:
    # max length 64, 128, 256 and 512 should work (if your sequence is short enough)
    return HFEmbedder(model_path, max_length=max_length, torch_dtype=torch.bfloat16).to(device)

def load_clip(model_path: str, device: Union[str, torch.device] = "cuda") -> HFEmbedder:
